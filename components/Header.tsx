...
function Header() {
  return (
    <header className="realative p-16 text-center">
      <Link href="/">
      ...
      <div className="absolute -top-5 right-5 flex space-x-2">
        <Link href="/">
          <FilePen className="w-8 h-8 lg:w-10 lg:h10 mx-auto text-purple-500 mt-10 border border-purple-500 p-2  rounded-md hover:opacity-50 cursor-pointer" />
        </Link>
        <Link href="/">
          <BookOpen className="w-8 h-8 lg:w-10 lg:h10 mx-auto text-purple-500 mt-10 border border-purple-500 p-2  rounded-md hover:opacity-50 cursor-pointer" />
        </Link>
      </div>
    </header>
  );
